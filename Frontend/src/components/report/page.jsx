...
export default function ReportPage() {
  ...
  const [file, setFile] = useState(null);//this file is the image we are going to upload to gemini ai

  const [preview, setPreview] = useState(null);
  //preview of the image uploaded
...
//THIS IS THE WORK OF GEMINI API
